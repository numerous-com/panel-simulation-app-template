...
class SimulationApp:
    def __init__(self):
        ...
        self.input1 = pn.widgets.FloatInput(name='Input 1', value=1.0, start=0.1, end=10.0, step=0.1)
        self.input2 = pn.widgets.FloatInput(name='Input 2', value=2.0, start=0.1, end=10.0, step=0.1)
        self.duration = pn.widgets.FloatInput(name='Duration (s)', value=2.0, start=1.0, end=100.0, step=0.1)
